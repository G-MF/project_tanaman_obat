            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-900">Tambah Data Obat Tradisional</h1>
                                ...
                                <div class="card shadow mb-4">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input autocomplete="off" type="text" class="form-control" name="nama_obat" id="nama_obat" required>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea class="form-control" name="indikasi" id="indikasi" rows="4" required></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="aturan_pakai" class="col-sm-2 col-form-label">Aturan Pakai</label>
                                            <div class="col-sm-10">
                                                <input autocomplete="off" type="text" class="form-control" name="aturan_pakai" id="aturan_pakai" required>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <select class="form control select2" name="nama_tanaman" id="nama_tanaman" data-placeholder="Pilih" style="width: 100%;" required>
                                                    ...
                                                    foreach ($tan as $item) {
                                                    ?>
                                                        <option value="<?= $item['nama_tanaman'] ?>"><?= $item['nama_tanaman'] ?></option>
                                                    <?php } ?>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea class="textarea" name="komposisi" id="komposisi" required style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
                                            </div>
                                        </div>
